...
class OrderDetailsCard extends StatefulWidget {
  ...
  OrderDetailsCard({Key key, this.order}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                'Extra description  for the address, Extra description  for the address..',
                style: TextStyle(
                  fontFamily: 'SF Pro Rounded',
                  fontSize: 10,
                  color: const Color(0xff888a8d),
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Text(
                  'Some of the order notes if the user put extra info for the order ….',
                  style: TextStyle(
                    fontFamily: 'SF Pro Rounded',
                    fontSize: 11,
                    color: const Color(0xff3c4959),
